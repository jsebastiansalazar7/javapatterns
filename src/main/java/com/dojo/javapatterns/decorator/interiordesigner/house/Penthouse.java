...
@Data
@Builder
public class Penthouse implements PropertyActions {
    ...
    public void showPropertyComposition() {
        System.out.println("The penthouse consists of " +
                bathrooms.size() + " bathroom, " +
                bedrooms.size() + " bedroom" +
                "1 dinning room, 1 livingRoom, 1 kitchen, " +
                "1 attic, 1 garage, 1 terrace, " +
                "1 clothes room, and 1 leisure room\n");;
    }

    @Override
    public void showPropertyStyle() {
        System.out.println("The style of the penthouse goes as follows:");

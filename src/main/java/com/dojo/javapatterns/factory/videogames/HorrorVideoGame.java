...
@SuperBuilder
@Data
public class HorrorVideoGame extends VideoGame {

    public HorrorVideoGame(String title, String description, int year, List<GameModeEnum> gameMode,
    ...
    public void designGame() {
        System.out.println("- Design for the Horror video game " + this.getTitle() + " has started");
    }

    @Override
    public void makeGame() {
        System.out.println("- Production for the Horror video game " + this.getTitle() +
    ...
    public void sellGame() {
        ...
        System.out.println("- The Horror video game " + this.getTitle() +
